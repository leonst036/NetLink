            ...
            <div className="dm-action-bar">
                <form onSubmit={onCreateSubmit} className="dm-form-inline">
                    <input
                        className="dm-input"
                        type="text"
                        placeholder="Network Name (e.g. app-net)"
                        value={networkName}
                        ...
                        {filteredNetworks.map((net: any, idx: number) => {
                            ...
                            return (
                                <tr key={net.ID || idx}>
                                    ...
                                    <td><strong>{net.Name}</strong> {isDefault && <span className="dm-pill-sm">System</span>}</td>
                                    <td><span className="dm-pill">{net.Driver || 'bridge'}</span></td>
                                    <td>{net.Scope || 'local'}</td>
                                    <td>
                                        {!isDefault ? (
                                            <button
